...
#!/usr/bin/env python3
"""
pythoneda/shared/banner/banner.py
...
"""
from pythoneda.shared.banner import Metadata
...
class Banner(Metadata):
    ...
    def build(self) -> List[str]:
        ...
        result = []
        result.append(
            " \033[32m             _   _                          \033[35m_\033[0m"
        )
        result.append(
            f" \033[32m\033[37mGPLv3       \033[32m| | | |                     \033[35m{self._pythoneda_dep_count:>3}\033[35m| |\033[36m{self._dep_count}\033[0m"
        )
        result.append(
        ...
        result.append(
            f" \033[32m|_|\033[37m{self.space}\033[31m{self.arch_role}\033[36m{self.layer}\033[32m |___/ {' '*line2_first_half}\033[33m{self.repo.upper()}{' '*line2_second_half}\033[37mhttps://patreon.com/rydnr\033[0m"
        )
        result.append("")
        result.append(
            f" Thank you for using \033[31m{self.org}/{self.repo} {self.tag}\033[0m, \033[32mpython\033[34me\033[35md\033[36ma\033[0m in general, and for your appreciation of free software."
        )
        result.append("")
        return result
